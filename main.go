...
import (
	...
	"kubebuilder_test/elasticweb-operator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "38dace25.elasticweb-operator",
	})
	if err != nil {
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = (&webappv1.ElasticWeb{}).SetupWebhookWithManager(mgr); err != nil {
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = (&webappv1.NodePool{}).SetupWebhookWithManager(mgr); err != nil {
