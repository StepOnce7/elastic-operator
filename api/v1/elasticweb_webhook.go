...
//+kubebuilder:webhook:path=/mutate-webapp-elasticweb-operator-v1-elasticweb,mutating=true,failurePolicy=fail,sideEffects=None,groups=webapp.elasticweb-operator,resources=elasticwebs,verbs=create;update,versions=v1,name=melasticweb.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-webapp-elasticweb-operator-v1-elasticweb,mutating=false,failurePolicy=fail,sideEffects=None,groups=webapp.elasticweb-operator,resources=elasticwebs,verbs=create;update,versions=v1,name=velasticweb.kb.io,admissionReviewVersions=v1
